...
2. Créez un fichier `.env` dans le répertoire racine avec les variables d'environnement nécessaires :
    ```plaintext
...
3. Construisez et exécutez les containers Docker en utilisant Docker Compose :
    ```bash
